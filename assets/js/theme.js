/**
 * ==========================================================================
 * THEME CONTROLLER ENGINE (theme.js)
 * ==========================================================================
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Retrieve previous choice or fall back to system defaults
    const currentTheme = localStorage.getItem('doitnow_theme') || 
                         (window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light');
    
    // Initialize root data attribute
    ...
    function updateToggleIcon(theme) {
        if (!themeIcon) return;
        if (theme === 'dark') {
            // Render a Sun Icon using Lucide path
            ...
            // Render a Moon Icon using Lucide path
